...
`;document.head.appendChild(s);}
  ...
  let tries=0;function boot(){if(!isHome())return;if(products().length){install();return;}if(++tries<400)setTimeout(boot,50);}if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',boot,{once:true});else boot();
})();
