...
@media(max-width:1023px){.kt-grid{grid-template-columns:repeat(3,minmax(0,1fr))}}@media(max-width:767px){#kt-catalogue-controls{padding:0 12px 6px}#kt-home-catalogue{padding:6px 12px 105px}.kt-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.kt-card-img{height:145px;padding:7px}.kt-card-body{padding:9px}.kt-card h3{font-size:13px;min-height:32px}.kt-desc{display:none}.kt-view{font-size:9px;padding:6px}.kt-pack{padding:6px;font-size:9px}.kt-buy-row{gap:5px}.kt-qty-btn{width:27px}.kt-qty-value{min-width:26px}.kt-add{font-size:10px}#kt-order-bar{bottom:9px}.kt-toast{right:12px;bottom:70px}}
